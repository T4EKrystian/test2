...
const History: React.FC = () => {
  return (
    <section className="relative py-24 md:py-32 bg-[#08120b] text-white overflow-hidden border-t border-white/5">
      {/* Background Pattern */}
      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1 text-left">
            ...
            <h2 className="text-4xl md:text-6xl font-display text-white mb-8 leading-tight animate-fade-up uppercase tracking-tight">
              The Spirit <br /> <span className="italic font-serif normal-case text-royal-gold/90">of the Game</span>
            </h2>
            
            <div className="space-y-6 text-stone-400 font-light text-sm leading-loose border-l border-white/10 pl-6 animate-fade-up">
              <p>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 relative">
             <div className="relative z-10 group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#08120b] via-transparent to-transparent z-10 pointer-events-none"></div>
                ...
                <img 
                  ...
                  className="w-full aspect-[4/3] object-cover shadow-2xl rounded-sm filter brightness-[0.6] contrast-[1.1] grayscale-[30%] group-hover:brightness-[0.8] group-hover:scale-[1.02] transition-all duration-1000 ease-out"
                />

...
const Dining: React.FC = () => {
  ...
  return (
    <section id="dining" className="relative py-20 md:py-0 min-h-[600px] md:h-screen flex items-center bg-[#0a0a0a] overflow-hidden">
      
      <div className="absolute inset-0 z-0">
         <img src="https://images.unsplash.com/photo-1505935428862-770b6f24f629?q=80&w=2067&auto=format&fit=crop" className="w-full h-full object-cover opacity-50 md:opacity-50 grayscale-[30%]" alt="Sierra Restaurant" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
        <div className="max-w-xl animate-fade-up pt-12 md:pt-0 text-left">
           <div className="flex items-center gap-4 mb-6 md:mb-8">
            ...
            <p className="text-stone-300 md:text-stone-400 font-light leading-loose mb-8 md:mb-12 text-sm md:text-lg border-l border-royal-gold/50 pl-6">
